...
public class ViewReturnedBooks_TransactionTest {
	WebDriver chrome;
	@BeforeTest
	private void beforeTransactionTest() {
		...
		chrome.findElement(By.xpath(
				"/html/body/div[2]/div/div/div/ul/li[3]/ul/li[1]/a"))
		.click();
	}	
	...
	public void foundData(String from, String to) {
		...
		wait.until(ExpectedConditions.visibilityOf(chrome.findElement(By.xpath("//div[@id='myModal4']//div[@class='modal-body']//form[@class='form-horizontal']//div[@class='control-group']//div[@class='controls']//input[@id='inputPassword']"))));
		chrome.findElement(By.xpath("//div[@id='myModal4']//div[@class='modal-body']//form[@class='form-horizontal']//div[@class='control-group']//div[@class='controls']//input[@id='inputEmail']")).clear();
		chrome.findElement(By.xpath("//div[@id='myModal4']//div[@class='modal-body']//form[@class='form-horizontal']//div[@class='control-group']//div[@class='controls']//input[@id='inputEmail']")).sendKeys(from);
		chrome.findElement(By.xpath("//div[@id='myModal4']//div[@class='modal-body']//form[@class='form-horizontal']//div[@class='control-group']//div[@class='controls']//input[@id='inputPassword']")).clear();
		chrome.findElement(By.xpath("//div[@id='myModal4']//div[@class='modal-body']//form[@class='form-horizontal']//div[@class='control-group']//div[@class='controls']//input[@id='inputPassword']")).sendKeys(to);
		chrome.findElement(By.xpath("//*[@id=\"myModal4\"]/div[2]/form/div[3]/div/button")).click();
